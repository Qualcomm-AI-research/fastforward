...
from .dtypes import can_support_bitwidth as can_support_bitwidth
...
from .static import quantize as quantize
...
from .static import quantize_per_tile as quantize_per_tile
