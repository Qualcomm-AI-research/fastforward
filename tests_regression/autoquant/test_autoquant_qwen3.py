...
@pytest.fixture
def model(model_name: str, device: torch.device) -> Iterator[Qwen3ForCausalLM]:
...
def test_autoquant_qwen3_matches_fp_perplexity(
    ...
    # GIVEN the wikitext-validation perplexity of a full-precision Qwen3 model
    ...
    ff.autoquantize(
        model,
        output_path=tmp_path / "_autoquantized_qwen3.py",
